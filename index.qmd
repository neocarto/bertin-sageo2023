...
Le développement de la bibliothèque `bertin` s'appuie en grande partie sur le librairie javascript [d3.js](https://d3js.org/) développée par Mike Bostock depuis 10 ans. Le développement a débuté en novembre 2021. Il y a 8 contributeurs. 254 ⭐ sur Github.
...
viewof shadowdy = Inputs.range([-50, 50], {label: "dx", step: 1, value: 5})
...
//| eval: true
bertin.draw({params: {width: 600, projection: "Bertin1953"} ,layers: [ 
  {type: type, geojson: world2, values: "POP",  k: 40, stroke:  mylayer == "Cercles" ? {type: "typo", values: "continent"} :  "none", fill: "none", strokeWidth, dorling: dor},
...
Avec le type **`smooth`**, on peut représenter ces données sur grilles sous la forme d'une fausse 3D.
...
<br/>Nicolas Lambert, Timothée Giraud, Matthieu Viry et Ronan Ysebaert
