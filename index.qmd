...
::: {.column width="60%"}
<br/><br/> [bertin](https://github.com/neocarto/bertin) est une bibliothèque écrite en [JavaScript](https://developer.mozilla.org/fr/docs/Web/JavaScript) qui permet de réaliser des cartes thématiques pour le web.
...
**Observable**, c'est aussi une plateforme web qui héberge des </ins>notebooks</ins> computationnels sur la visualisation de données.
...
Le développement de la bibliothèque `bertin` s'appuie en grande partie sur le librairie javascript [d3.js](https://d3js.org/) développée par Mike Bostock depuis 10 ans. Le développement a débuté en novembre 2021. Il y a 8 contributeurs. 256 ⭐ sur Github.
...
Elle permet de réaliser<br/>de nombreux types de cartes thématiques.

![](img/bannerbert.png)

Parti pris :

👉 cartographie <ins>**vectorielle**</ins>

👉 cartographie <ins>**interactive**</ins> pour le web

👉 une recherche <ins>**esthétique**</ins>

👉 plutôt à partir de <ins>**maillages**</ins> administratifs

👉 plutôt avec des <ins>**données**</ins> pas trop volumineuses

👉 forte intégration avec l'écosystème d'<ins>**Observable**</ins>
...
<br/>La fonction **`match()`** permet de tester la compatibilité entre les données et le fonde de carte.<br/>
...
<br/>Nicolas Lambert, Timothée Giraud, Matthieu Viry et Ronan Ysebaert<br/><br/>

👉 <ins>Code</ins> et <ins>documentation</ins> : [github.com/neocarto/bertin](https://github.com/neocarto/bertin)<br/>
👉 <ins>Exemples</ins> : [observablehq.com/collection/@neocartocnrs/bertin](https://observablehq.com/collection/@neocartocnrs/bertin)<br/>
👉 <ins>Issues</ins> : [github.com/neocarto/bertin/issues](https://github.com/neocarto/bertin/issues)

<br/>

<small>*Cette présentation est disponible ici : [neocarto.github.io/bertin-sageo2023](https://neocarto.github.io/bertin-sageo2023)*</small>
